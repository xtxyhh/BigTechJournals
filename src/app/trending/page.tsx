...
title: "Trending",
description:
"Most read, most liked, most bookmarked, fastest growing, trending today, and trending this week stories from BigTechJournals.",
path: "/trending",
});
...
title: "Most read",
icon: Flame,
stories: mostRead.stories,
},
{
title: "Most liked",
icon: Heart,
stories: mostLiked.map(toStoryCard),
},
{
title: "Most bookmarked",
icon: Heart,
stories: mostBookmarked.map(toStoryCard),
},
{
title: "Fastest growing",
icon: LineChart,
stories: fastestGrowing.stories,
},
{
title: "Trending today",
icon: TrendingUp,
stories: trendingToday.map(toStoryCard),
},
{
title: "Trending this week",
icon: TrendingUp,
stories: trendingWeek.map(toStoryCard),
},
];
  ...
  <section className="relative overflow-hidden px-4 pb-16 pt-24 sm:px-6 lg:px-8">
    ...
    <div className="relative mx-auto max-w-7xl">
      ...
      <p className="mt-7 max-w-3xl text-lg leading-8 text-white/68">
        Ranked by reads, momentum, and recency across stories,
        interview experiences, and career playbooks.
      </p>
    </div>
  </section>
    ...
    {sections.map((section) => (
      <div key={section.title}>
        <div className="mb-6 flex items-center justify-between gap-4">
          ...
          <Link
            href="/stories"
            className="hidden rounded-full border border-white/[0.1] px-4 py-2 text-sm text-white/65 transition hover:text-white sm:inline-flex"
          >
            All stories
          </Link>
        </div>
