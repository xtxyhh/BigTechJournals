      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-24">
              ...
              <div className="flex gap-4 pt-2">
                {socials.map(({ icon: Icon, href, label }) => (
                  <a
                    ...
                    aria-label={label}
                    className="w-10 h-10 rounded-full bg-surface-card border border-white/[0.08] flex items-center justify-center text-surface-muted hover:bg-blue-600 hover:text-white hover:border-blue-500 transition-all duration-200"
                  >
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-4 text-surface-muted font-medium">
              ...
              <li><Link href="/stories" className="hover:text-blue-400 transition-colors">Categories</Link></li>
              <li><Link href="/submit" className="hover:text-blue-400 transition-colors">Submit Story</Link></li>
              <li><Link href="/company/google" className="hover:text-blue-400 transition-colors">Companies</Link></li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-4 text-surface-muted font-medium">
              <li><Link href="/category/interview-prep" className="hover:text-blue-400 transition-colors">Interview Prep</Link></li>
              <li><Link href="/category/dsa" className="hover:text-blue-400 transition-colors">DSA</Link></li>
              <li><Link href="/category/internships" className="hover:text-blue-400 transition-colors">Internships</Link></li>
              <li><Link href="/category/career-switch" className="hover:text-blue-400 transition-colors">Career Switch</Link></li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-4 text-surface-muted font-medium">
              <li><a href={`mailto:${email}`} className="hover:text-blue-400 transition-colors">{email}</a></li>
              {settings.contactPhone && <li>{settings.contactPhone}</li>}
              <li><Link href="/contact" className="hover:text-blue-400 transition-colors">Send a message →</Link></li>
        ...
        <div className="border-t border-white/[0.08] py-8 flex flex-col md:flex-row justify-between items-center text-sm text-surface-muted/70 font-medium">
          ...
          <div className="flex gap-8 mt-4 md:mt-0">
            ...
            <Link href="/submit" className="hover:text-white transition-colors duration-200">Write for us</Link>
          </div>
        </div>
      </div>

      <div className="w-full text-center pointer-events-none select-none overflow-hidden leading-none opacity-[0.03]">
        <span className="text-[12vw] md:text-[14vw] font-black text-white uppercase tracking-tighter whitespace-nowrap block translate-y-[20%]">
          Big Tech Journals
        </span>
      </div>
    </footer>
