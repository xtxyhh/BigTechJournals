...
const FeaturedCard = ({ post }: { post: FeaturedPost }) => {
  ...
  return (
    <Link
      ...
      className={`relative group overflow-hidden rounded-4xl h-[300px] lg:h-[400px] w-full block ${
        post.className || ""
      }`}
    >
      <Image
  ...
  return (
    <section className="py-16 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-10 flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        ...
        <Link href="/stories?featured=true" className="px-6 py-3 bg-slate-900 text-white text-sm font-medium rounded-full hover:bg-slate-800 transition-colors shadow-lg hover:shadow-xl inline-flex items-center gap-2">
