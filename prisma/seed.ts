...
const companies = [
  ...
  },
  {
    name: "JPMorgan Chase",
    slug: "jpmorgan",
    logo: "/company-logos/jpmorgan.png",
    description: "JPMorgan Chase technology roles combine finance scale, distributed systems, data platforms, and strong engineering fundamentals.",
    interviewProcess: { rounds: [{ name: "Online Assessment", description: "Coding and aptitude screening." }, { name: "Technical Interviews", description: "DSA, projects, CS fundamentals, and role-specific discussion." }], tips: ["Prepare DSA patterns", "Know your projects deeply", "Understand financial technology basics"] },
    roadmap: { phases: [] },
    resources: { books: [], youtube: [], courses: [], leetcode: ["JPMorgan tagged"] },
    salaryInfo: {},
    faqs: [],
  },
  {
    ...
    slug: "morgan-stanley",
    logo: "",
    description: "Morgan Stanley hires engineers for financial platforms, backend systems, data, and infrastructure with interviews centered on fundamentals and problem solving.",
    interviewProcess: { rounds: [{ name: "Assessment", description: "Coding and aptitude round." }, { name: "Technical + HR", description: "DSA, projects, DBMS, OS, and behavioral questions." }], tips: ["Revise CS fundamentals", "Practice timed coding", "Prepare concise project stories"] },
    roadmap: { phases: [] },
    resources: { books: [], youtube: [], courses: [], leetcode: [] },
    salaryInfo: {},
    faqs: [],
  },
  {
    ...
    slug: "paypal",
    logo: "",
    description: "PayPal engineering interviews focus on product thinking, backend fundamentals, scalable systems, and practical coding skills.",
    interviewProcess: { rounds: [{ name: "Technical Screen", description: "Coding and project discussion." }, { name: "Interview Loop", description: "DSA, design, and behavioral rounds." }], tips: ["Practice API and backend design", "Prepare payments-domain project context"] },
    roadmap: { phases: [] },
    resources: { books: [], youtube: [], courses: [], leetcode: [] },
    salaryInfo: {},
    faqs: [],
  },
  {
    ...
    slug: "goldman-sachs",
    logo: "",
    description: "Goldman Sachs technology roles emphasize problem solving, CS fundamentals, clean communication, and finance-scale engineering.",
    interviewProcess: { rounds: [{ name: "Assessment", description: "Coding, aptitude, and CS fundamentals." }, { name: "Technical Interviews", description: "Projects, DSA, OOP, DBMS, and behavioral discussion." }], tips: ["Practice arrays, strings, DP, and SQL", "Prepare internship and project details"] },
    roadmap: { phases: [] },
    resources: { books: [], youtube: [], courses: [], leetcode: [] },
    salaryInfo: {},
    faqs: [],
  },
  {
    ...
    slug: "blinkit",
    logo: "",
    description: "Blinkit engineering roles value product velocity, ownership, practical system design, and strong coding fundamentals.",
    interviewProcess: { rounds: [{ name: "Technical Screen", description: "Coding and project discussion." }, { name: "Team Rounds", description: "Problem solving, ownership, and product engineering depth." }], tips: ["Show ownership", "Prepare scale and product tradeoffs"] },
    roadmap: { phases: [] },
    resources: { books: [], youtube: [], courses: [], leetcode: [] },
    salaryInfo: {},
    faqs: [],
  },
  {
    ...
    slug: "graviton",
    logo: "",
    description: "Graviton quantitative and engineering roles require strong problem solving, systems thinking, programming fluency, and mathematical maturity.",
    interviewProcess: { rounds: [{ name: "Problem Solving", description: "Math, logic, and coding assessment." }, { name: "Technical Interviews", description: "Algorithms, systems, probability, and role-specific discussion." }], tips: ["Practice probability and puzzles", "Keep code clean and fast"] },
    roadmap: { phases: [] },
    resources: { books: [], youtube: [], courses: [], leetcode: [] },
    salaryInfo: {},
    faqs: [],
  },
  {
    ...
    slug: "yal",
    logo: "",
    description: "YAL engineering stories on BigTechJournals cover product engineering growth, career moves, and practical interview preparation.",
  ...
  },
  {
    ...
    slug: "vercel",
    logo: "",
    description: "Vercel engineering roles focus on frontend infrastructure, developer experience, distributed systems, and product-quality execution.",
    interviewProcess: { rounds: [{ name: "Technical Screen", description: "Role-specific engineering discussion." }, { name: "Loop", description: "Coding, architecture, product sense, and collaboration." }], tips: ["Show shipped work", "Understand modern web infrastructure"] },
    roadmap: { phases: [] },
    resources: { books: [], youtube: [], courses: [], leetcode: [] },
    salaryInfo: {},
    faqs: [],
