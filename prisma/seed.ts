...
const companies = [
  ...
  },
  {
    ...
    slug: "barclays",
    logo: "",
    description: "Barclays technology roles focus on financial systems, banking infrastructure, data platforms, and strong engineering fundamentals.",
  ...
  },
  {
    ...
    slug: "citadel",
    logo: "",
    description: "Citadel hires exceptional engineers for quantitative trading, market making, and high-frequency systems with rigorous problem-solving interviews.",
    interviewProcess: { rounds: [{ name: "Problem Solving", description: "Math, probability, and coding assessment." }, { name: "Technical Interviews", description: "Algorithms, systems, and quantitative reasoning." }], tips: ["Practice probability and statistics", "Strong C++/Python skills", "Focus on optimization"] },
    roadmap: { phases: [] },
    resources: { books: [], youtube: [], courses: [], leetcode: [] },
    salaryInfo: {},
    faqs: [],
  },
  {
    ...
    slug: "deloitte",
    logo: "",
    description: "Deloitte technology consulting roles combine business transformation, digital solutions, and engineering across various industries.",
    interviewProcess: { rounds: [{ name: "Assessment", description: "Aptitude and technical screening." }, { name: "Technical + HR", description: "Projects, CS fundamentals, and behavioral questions." }], tips: ["Understand consulting frameworks", "Prepare case studies", "Show business acumen"] },
    roadmap: { phases: [] },
    resources: { books: [], youtube: [], courses: [], leetcode: [] },
    salaryInfo: {},
    faqs: [],
  },
  {
    ...
    slug: "harness",
    logo: "",
    description: "Harness engineering focuses on continuous delivery, software delivery platforms, and developer experience with modern cloud-native technologies.",
    interviewProcess: { rounds: [{ name: "Technical Screen", description: "Coding and system design." }, { name: "Interview Loop", description: "DSA, architecture, and product engineering." }], tips: ["Know CI/CD concepts", "Understand Kubernetes", "Show DevOps expertise"] },
    roadmap: { phases: [] },
    resources: { books: [], youtube: [], courses: [], leetcode: [] },
    salaryInfo: {},
    faqs: [],
  },
  {
    ...
    slug: "ibm",
    logo: "",
    description: "IBM offers diverse technology roles across cloud, AI, quantum computing, and enterprise solutions with focus on innovation and scale.",
    interviewProcess: { rounds: [{ name: "Technical Assessment", description: "Coding and domain knowledge." }, { name: "Interview Rounds", description: "Technical, behavioral, and culture fit." }], tips: ["Understand IBM's technology stack", "Prepare enterprise scenarios", "Show adaptability"] },
    roadmap: { phases: [] },
    resources: { books: [], youtube: [], courses: [], leetcode: [] },
    salaryInfo: {},
    faqs: [],
  },
  {
    ...
    slug: "meesho",
    logo: "",
    description: "Meesho engineering roles focus on e-commerce scale, social commerce, and rapid product development with strong problem-solving skills.",
    interviewProcess: { rounds: [{ name: "Technical Screen", description: "Coding and system design." }, { name: "Team Rounds", description: "Problem solving, ownership, and product depth." }], tips: ["Understand e-commerce domain", "Show scalability", "Prepare for rapid iteration"] },
    roadmap: { phases: [] },
    resources: { books: [], youtube: [], courses: [], leetcode: [] },
    salaryInfo: {},
    faqs: [],
  },
  {
    ...
    slug: "netapp",
    logo: "",
    description: "NetApp specializes in data management, cloud storage, and hybrid cloud solutions with engineering roles focused on storage systems and data infrastructure.",
    interviewProcess: { rounds: [{ name: "Technical Screen", description: "Coding and storage fundamentals." }, { name: "Interview Loop", description: "System design, storage concepts, and behavioral." }], tips: ["Understand storage systems", "Know cloud architectures", "Prepare distributed systems"] },
    roadmap: { phases: [] },
    resources: { books: [], youtube: [], courses: [], leetcode: [] },
    salaryInfo: {},
    faqs: [],
  },
  {
    ...
    slug: "oracle",
    logo: "",
    description: "Oracle technology roles span cloud infrastructure, database systems, enterprise applications, and SaaS platforms with focus on reliability and scale.",
    interviewProcess: { rounds: [{ name: "Technical Assessment", description: "Coding and database concepts." }, { name: "Interview Rounds", description: "DSA, system design, and domain knowledge." }], tips: ["Know database internals", "Understand cloud services", "Prepare enterprise scenarios"] },
    roadmap: { phases: [] },
    resources: { books: [], youtube: [], courses: [], leetcode: [] },
    salaryInfo: {},
    faqs: [],
  },
  {
    ...
    slug: "visa",
    logo: "",
    description: "Visa engineering focuses on payment systems, financial technology, secure transactions, and global payment infrastructure with emphasis on reliability and security.",
    interviewProcess: { rounds: [{ name: "Technical Screen", description: "Coding and payments domain." }, { name: "Interview Loop", description: "DSA, system design, and security concepts." }], tips: ["Understand payment systems", "Know security best practices", "Prepare high-availability scenarios"] },
    roadmap: { phases: [] },
    resources: { books: [], youtube: [], courses: [], leetcode: [] },
    salaryInfo: {},
    faqs: [],
